    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('time_stamp', models.DateTimeField(auto_now_add=True, default=datetime.datetime(2015, 8, 2, 12, 3, 47, 920276, tzinfo=utc))),
                ('picture', models.ImageField(null=True, blank=True, verbose_name='照片', upload_to='academic')),
            ],
            options={
                'verbose_name': '学术交流活动',
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('content', models.TextField(null=True)),
                ('time_stamp', models.DateTimeField(auto_now_add=True, default=datetime.datetime(2015, 8, 2, 12, 3, 47, 920276, tzinfo=utc))),
                ('picture', models.ImageField(null=True, blank=True, verbose_name='照片', upload_to='news')),
            ],
            options={
                'verbose_name': '新闻动态',
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('content', models.TextField(null=True)),
                ('time_stamp', models.DateTimeField(auto_now_add=True, default=datetime.datetime(2015, 8, 2, 12, 3, 47, 920276, tzinfo=utc))),
                ('picture', models.ImageField(null=True, blank=True, verbose_name='照片', upload_to='notices')),
            ],
            options={
                'verbose_name': '通知公告',
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('postcode', models.CharField(verbose_name='邮政编码', default='000000', max_length=6)),
                ('edu_bg', models.TextField(blank=True, verbose_name='教育背景')),
                ('image', models.ImageField(null=True, blank=True, verbose_name='个人照片', upload_to='memberImg')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('content', models.TextField(null=True)),
                ('time_stamp', models.DateTimeField(auto_now_add=True, default=datetime.datetime(2015, 8, 2, 12, 3, 47, 920276, tzinfo=utc))),
                ('picture', models.ImageField(null=True, blank=True, verbose_name='照片', upload_to='relax')),
            ],
            options={
                'verbose_name': '休闲活动',
            },
